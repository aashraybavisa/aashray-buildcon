      ...
      <View style={[styles.section, styles.container]}>
        <View style={styles.story}>
          <View style={styles.storyCopy}>
            ...
            >
              We coordinate the people, materials, approvals, and site work that make a project move. You get
              one accountable team, regular progress updates, and a clear line of communication from the first
